...
(() => {
    ...
    const i18n = {
        de: {
            ...
            redirecting: 'Weiterleitung zur Produktseite…',
            actionExecuted: 'Der Agent hat eine Aktion auf der Seite ausgeführt.',
        ...
        en: {
            ...
            actionExecuted: 'Agent executed an action on the page.',
        ...
        fr: {
            ...
            redirecting: 'Redirection vers la page produit…',
            actionExecuted: `L'agent a exécuté une action sur la page.`,
        ...
        es: {
            ...
            actionExecuted: 'El agente ejecutó una acción en la página.',
